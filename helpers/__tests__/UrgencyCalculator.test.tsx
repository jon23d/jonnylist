...
jest.mock('@/helpers/Tasks', () => ({
  ...jest.requireActual('@/helpers/Tasks'),
  getAgeInDays: jest.fn(() => 365), // This will always result in the addition of 1.0 * ageCoefficient
}));
...
describe('UrgencyCalculator', () => {
  ...
  beforeEach(() => {
    ...
    task = taskFactory();
    (getAgeInDays as jest.Mock).mockReturnValue(365);
  });
